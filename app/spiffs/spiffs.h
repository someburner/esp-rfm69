...
// s32_t SPIFFS_size(spiffs *fs, spiffs_file fh);
//
// void myspiffs_mount(void);
// void myspiffs_unmount(void);
// int myspiffs_mounted(void);
//
// int myspiffs_open(const char *name, int flags);
// int myspiffs_open_by_dirent(struct spiffs_dirent *e, int flags);
// spiffs_DIR *myspiffs_opendir(const char *name, spiffs_DIR *d);
// struct spiffs_dirent *myspiffs_readdir(spiffs_DIR *d, struct spiffs_dirent *e);
// int myspiffs_closedir(spiffs_DIR *d);
//
// // int myspiffs_closedir(int *d);
...
// size_t myspiffs_remove(const char *path);
// size_t myspiffs_fremove(int fd);
//
// int myspiffs_listall(void);
//
// int myspiffs_getc(int fd);
// int myspiffs_ungetc(int c, int fd);
//
// int myspiffs_stat(const char *name, spiffs_stat *s);
// int myspiffs_fstat(int fd, spiffs_stat *s);
//
...
// int myspiffs_fmatch(int fd, const char *name);
